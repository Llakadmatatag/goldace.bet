...
export default function CSGOWINLeaderboard() {
  ...
  useEffect(() => {
    if (!metaData?.date_end) return;
    
    const timer = setInterval(() => {
      const now = new Date().getTime();
      const endDate = new Date(metaData.date_end).getTime();
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black">
      ...
      <section className="relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="relative bg-gradient-to-br from-blue-900/20 to-blue-800/10 backdrop-blur-md border border-blue-800/30 rounded-2xl p-8 lg:p-12 hover:bg-blue-900/30 transition-all duration-300 overflow-hidden">
            {/* Background Image */}
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
              ...
              <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
                <img src="/images/partners/csgowin-logo.png" alt="CSGOWIN" className="w-55 h-auto mb-4" />
      ...
      <section className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-blue-900/20 backdrop-blur-md border border-blue-800/30 rounded-xl overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="border-b border-blue-800/30">
                    <th className="px-4 py-4 text-left text-blue-400 font-semibold w-20">Rank</th>
                    <th className="px-6 py-4 text-left text-blue-400 font-semibold">Username</th>
                    <th className="px-6 py-4 text-right text-blue-400 font-semibold">Wager</th>
                    <th className="px-6 py-4 text-right text-blue-400 font-semibold">Prize</th>
                  </tr>
                </thead>
                <tbody>
                  {loading ? (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl font-audiowide text-white mb-4">
              Previous <span className="text-blue-400">Winners</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-br from-yellow-900/20 to-amber-800/10 backdrop-blur-md border border-yellow-800/30 rounded-xl p-6 hover:bg-yellow-900/30 transition-all duration-300">
              ...
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 bg-gray-700/50 rounded-full flex items-center justify-center border-2 border-gray-600/50">
                  <img src="/images/partners/csgowin-coin.webp" alt="CSGOWIN" className="w-8 h-8 object-cover" />
                </div>
                <div>
                  <div className="text-white font-semibold">{maskUsername(previousWinners[0]?.username) || 'TBA'}</div>
            ...
            <div className="bg-gradient-to-br from-gray-900/20 to-slate-800/10 backdrop-blur-md border border-gray-800/30 rounded-xl p-6 hover:bg-gray-900/30 transition-all duration-300">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <div className="text-white font-semibold">{maskUsername(previousWinners[1]?.username) || 'TBA'}</div>
            ...
            <div className="bg-gradient-to-br from-orange-900/20 to-orange-800/10 backdrop-blur-md border border-orange-800/30 rounded-xl p-6 hover:bg-orange-900/30 transition-all duration-300">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <div className="text-white font-semibold">{maskUsername(previousWinners[2]?.username) || 'TBA'}</div>
            ...
            <div className="bg-gradient-to-br from-blue-900/20 to-blue-800/10 backdrop-blur-md border border-blue-800/30 rounded-xl p-6 hover:bg-blue-900/30 transition-all duration-300">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <div className="text-white font-semibold">{maskUsername(previousWinners[3]?.username) || 'TBA'}</div>
          ...
          <div className="text-center mt-8">
            <p className="text-gray-400 italic">
              Previous winners will be displayed here once the first competition ends.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl font-audiowide text-white mb-4">
              How to <span className="text-blue-400">Participate</span> in the Leaderboard
            </h2>
            <p className="text-xl text-blue-200 max-w-3xl mx-auto">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative">
              {/* Connection Line */}
              <div className="absolute left-4 top-8 bottom-8 w-0.5 bg-gradient-to-b from-blue-500/50 to-yellow-400/50"></div>
              
              <div className="space-y-8">
                <div className="flex items-start space-x-6">
                  <div className="relative flex-shrink-0">
                    <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-yellow-400 rounded-full flex items-center justify-center text-black font-bold text-sm z-10">
                      1
                    </div>
                  </div>
                  <div className="flex-1">
                    <h3 className="text-white font-semibold text-lg mb-1">Register on CSGOWIN</h3>
                    <p className="text-gray-400 mb-3">
                      Use this link or enter the Affiliate code <span className="text-blue-400 font-bold">'GoldAce'</span>
                    </p>
                    <div className="flex flex-col sm:flex-row gap-3">
                      <a
                        href="https://csgowin.com/?ref=GOLDACE"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="bg-gradient-to-r from-blue-500 to-yellow-400 text-black font-bold py-2 px-6 rounded-lg text-center hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 transform hover:scale-105"
                      >
                        Register via Link
                      </a>
                      <div className="flex items-center gap-2 bg-gray-800/50 border border-gray-600/30 rounded-lg px-4 py-2">
                        <span className="text-blue-400 font-mono font-bold">GoldAce</span>
                        <button
